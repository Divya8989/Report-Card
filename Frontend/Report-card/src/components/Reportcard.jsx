...
//           />
//           <h2 className="text-center text-orange-600 font-bold" style={{ fontSize: '30px' }}>Student Report Card</h2>
//         </div>

//         {/* <h2 className="text-center text-orange-600 font-bold" style={{ fontSize: '50px' }}>
